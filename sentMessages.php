...
$_SESSION['pagina']="sentMessages.php";
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Elenco <small>Messaggi Inviati</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="glyphicon glyphicon-share-alt"></i> Messaggi inviati
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <a href="#" ><button type="button" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-share-alt"></i> Messaggi inviati</button></a>
                            </div>
...
$query="SELECT * FROM pm WHERE user1='".$user."' ORDER BY timestamp ASC";
                                ...
                                <div class='table-responsive'>
                                    <table class='table table-bordered table-hover table-striped' >
                                        <thead style='width:100%'>
                                            <tr>
                                                <th style='width:10%' class='alert alert-info'>Ricevente</th>
                                        ...
                                        <a name=".$i."></a>
                                            <tr>
                                                <td><a href='new_message.php'><i class='glyphicon glyphicon-envelope'></i></a> ".$riga['user2']."</td>
                                                ...
                                                <td><a href='sentMessages.php?delete=".$riga['id']."' ><i class='glyphicon glyphicon-remove' ></i></a></td>
                                            </tr>
                                        </tbody>");
                                        $i++;
                                        $riga = mysql_fetch_array($ris);}
